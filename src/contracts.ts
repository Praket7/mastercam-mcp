...
export const READ_TOOLS = [
  ...
  "mastercam_doctor", "mastercam_help", "list_tool_categories", "discover_capabilities", "get_compatibility_matrix", "mastercam_plan",
  "inspect", "explain_operation", "get_operation_risks", "measure", "assert", "preview_operation_parameters", "verify_change",
  "find_operations", "get_version_report", "client_setup_check", "get_audit_history", "get_machine_context", "get_fixture_info",
  "generate_setup_sheet", "compare_tool_databases", "compare_nc_files", "validate_machine_profile"
] as const;

export const WRITE_TOOLS = [
  "apply_operation_parameter_preview", "change_tool", "create_operation", "regenerate_toolpath", "duplicate_operation", "update_stock", "set_work_offset", "rollback_change"
] as const;
