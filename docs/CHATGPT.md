...
The npm package is published as `mastercam-mcp@0.1.4`. The package command is intended for Codex and Claude Desktop stdio use. ChatGPT web should use the authenticated HTTP entry point described above.
