...
The supported package path is `mastercam-mcp@latest`; the current repository package version is `0.2.0`. Local desktop clients can use the stdio entry point. A remote/client-hosted integration should use the authenticated HTTP entry point.
