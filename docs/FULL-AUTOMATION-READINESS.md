...
- Full suite (143 tests), ESLint, TypeScript typecheck, build, package dry-run, and a live-source ISO 13399 loading check passed locally. Integration tests prove catalog-backed OD tool selection and translated work-offset travel checks. GitHub CI for the WCS update is pending.
